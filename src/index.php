...
<br>
  ...
  <div class="row gx-5">
    <div class="col">
     <div class="p-3 border bg-light"> <h5>A aplica&ccedil;&atilde;o</h5></div>
     <div>
    ...
    <div class="col">
      <div class="p-3 border bg-light"> <h5>A abordagem</h5></div>
      <div>
                <p>Os exemplos documentados seguem uma abordagem procedimental.</p>
              </div>
    </div>
    <div class="col">
      <div class="p-3 border bg-light"> <h5>Sugest&otilde;es</h5></div>
      <div>
